module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            production: {
                files: [{
                    src: srcFolder + "css/rabbit.less",
                    dest: targetFolder + "css/rabbit.css"
                }, {
                    src: srcFolder + "css/rabbit_responsive.less",
                    dest: targetFolder + "css/rabbit_responsive.css"
                }, {
                    src: srcFolder + "css/rabbit_bootstrap_overrides.less",
                    dest: targetFolder + "css/rabbit_bootstrap_overrides.css"
                }]
            }
        },
        requirejs: {
